...
export const INITIAL_LESSONS: FullLessonData[] = [
  {
    ...
    students: [
      { id: '1', name: 'Иван Смирнов', attendanceStatus: 'present', notes: 'Отличная работа с временами Present Perfect и Past Simple! Нужно закрепить неправильные глаголы.' },
  ...
  },
  {
    ...
    teacherName: 'Мария Иванова',
    date: '2026-09-23',
    dateFormatted: '23 сен 2026',
    dayOfWeek: 2,
    startTime: '18:45',
    endTime: '20:15',
    room: 'Онлайн (Zoom 1)',
    topic: 'Present Perfect Continuous vs Past Simple in practice',
    homework: 'Workbook p. 18-20, устное эссе',
    onlineMeetingUrl: 'https://meet.google.com/abc-defg-hij',
    status: 'scheduled',
    students: [
      { id: '1', name: 'Иван Смирнов', attendanceStatus: 'not_marked' },
