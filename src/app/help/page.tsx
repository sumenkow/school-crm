...
const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Перенос занятия: нажмите «Перенести» — откроется диалоговое окно выбора новой даты, времени начала/конца, онлайн-кабинета и причины переноса.',
                ...
                <div className="rounded-2xl border border-amber-200 bg-amber-50/40 p-5 space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs pt-1">
                    <div className="rounded-xl border border-slate-200 bg-white p-3 space-y-1">
                      ...
                      <p className="text-[11px] text-slate-500">Автоматическая проверка занятости комнат</p>
                    </div>
