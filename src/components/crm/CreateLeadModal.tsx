...
import { UserCheck, Phone, Check, GraduationCap, School, Info, ChevronDown, ChevronUp, Sparkles } from 'lucide-react';
...
export function CreateLeadModal({ isOpen, onClose, onCreated }: CreateLeadModalProps) {
  ...
  const modalFooter = (
    <div className="flex items-center justify-end gap-2.5 w-full">
      ...
      <button
        ...
        className="w-full sm:w-auto py-3.5 sm:py-2.5 px-5 bg-purple-600 hover:bg-purple-700 active:bg-purple-800 text-white font-semibold sm:font-bold rounded-xl text-sm shadow-md transition-colors flex items-center justify-center gap-2 cursor-pointer"
      >
  ...
  return (
    <MobileModalWrapper
      isOpen={isOpen}
      onClose={onClose}
      title="Быстрое создание лида"
      subtitle="4 обязательных поля для мгновенной фиксации"
