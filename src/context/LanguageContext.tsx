...
export const TRANSLATIONS: Record<SupportedLanguage, Record<string, string>> = {
  ru: {
    ...
    'teacher.selectLessonToMark': 'Выберите занятие для отметки:',
    'teacher.myWeek': 'Моя неделя',
    'teacher.lessonJournal': 'Журнал занятия',
    'teacher.hwSavedToCard': 'ДЗ сохраняется в карточку урока',
    'teacher.marked': 'Отмечено',
    'teacher.consecutiveMisses': 'пропуска подряд!',
    'teacher.statsAutoUpdate': 'Статистика по ученикам и группе обновится автоматически',
    'teacher.saveAttendance': 'Сохранить посещаемость',
    'teacher.weeklyScheduleTitle': 'Расписание занятий на текущую неделю:',
    'teacher.todaySubtitle': 'Сегодня:',
    'teacher.savedToStudentTimeline': 'Сохранится в таймлайн ученика',

    // Homework Modal
    'homework.sendModalTitle': 'Почтовая рассылка родителям',
    'homework.modalHeading': 'Домашнее задание:',
    'homework.teacher': 'Преподаватель:',
    'homework.tabSetup': 'Настройка рассылки',
    'homework.tabPreview': 'Предпросмотр письма',
    'homework.topicPrevLesson': 'Тема прошедшего занятия:',
    'homework.topicPlaceholder': 'Например: Past Simple vs Present Perfect',
    'homework.textLabel': '📝 Текст домашнего задания:',
    'homework.requiredField': 'Обязательное поле',
    'homework.textPlaceholder': 'Подробно опишите задание (номера страниц, упражнения, ссылки на материалы)...',
    'homework.deadlineLabel': '⏰ Срок выполнения (дедлайн):',
    'homework.deadlineDefault': 'К следующему занятию',
    'homework.deadlinePlaceholder': 'К следующему уроку (18.09.2026)',
    'homework.recommendationLabel': '💡 Дополнительные рекомендации:',
    'homework.recommendationPlaceholder': 'Например: обратить внимание на неправильные глаголы',
    'homework.recipientsTitle': 'Получатели (Родители и Студенты)',
    'homework.selectAll': 'Выбрать всех',
    'homework.deselectAll': 'Снять выбор',
    'homework.noEmailWarning': 'У {count} получателей не указан email. Вы можете ввести его прямо в строке ниже.',
    'homework.selfStudent': 'Сам ученик',
    'homework.primaryContact': 'Основной контакт',
    'homework.previewSubheading': 'Так будет выглядеть письмо в почтовом ящике родителя:',
    'homework.previewEmailSubject': 'Тема:',
    'homework.emailSchoolCenter': 'Образовательный центр',
    'homework.emailGreeting': 'Здравствуйте!',
    'homework.emailIntro': 'Направляем информацию по прошедшему занятию и задание для самостоятельной подготовки.',
    'homework.emailLessonDate': '📅 Дата урока:',
    'homework.emailTeacher': '👨‍🏫 Преподаватель:',
    'homework.emailTopic': '🎯 Тема занятия:',
    'homework.emailHomework': '📝 Задание на дом:',
    'homework.emailDeadline': '⏰ Срок сдачи:',
    'homework.emailTeacherRec': '💡 Рекомендация преподавателя:',
    'homework.emailAutoFooter': 'Сформировано автоматически через School CRM',
    'homework.selectedCountLabel': 'Выбрано получателей:',
    'homework.of': 'из',
    'homework.sendingBtn': 'Отправка через Resend...',
    'homework.sendBtn': 'Отправить',
    'homework.sentSuccess': 'ДЗ успешно отправлено родителям',
    'homework.timelineSaved': 'Факт отправки зафиксирован в Timeline истории учеников и родителей.',
  ...
  en: {
    ...
    'teacher.selectLessonToMark': 'SELECT LESSON FOR ATTENDANCE:',
    'teacher.myWeek': 'My Week',
    'teacher.lessonJournal': 'Lesson Journal',
    'teacher.hwSavedToCard': 'Homework is saved to lesson details',
    'teacher.marked': 'Recorded',
    'teacher.consecutiveMisses': 'consecutive absences!',
    'teacher.statsAutoUpdate': 'Student and group stats will update automatically',
    'teacher.saveAttendance': 'Save Attendance',
    'teacher.weeklyScheduleTitle': 'Class schedule for the current week:',
    'teacher.todaySubtitle': 'Today:',
    'teacher.savedToStudentTimeline': 'Will be saved to student timeline',

    // Homework Modal
    'homework.sendModalTitle': 'Email Homework to Parents',
    'homework.modalHeading': 'Homework:',
    'homework.teacher': 'Teacher:',
    'homework.tabSetup': 'Message Settings',
    'homework.tabPreview': 'Email Preview',
    'homework.topicPrevLesson': 'Topic of the completed lesson:',
    'homework.topicPlaceholder': 'E.g., Past Simple vs Present Perfect',
    'homework.textLabel': '📝 Homework task text:',
    'homework.requiredField': 'Required field',
    'homework.textPlaceholder': 'Describe the task in detail (page numbers, exercises, links)...',
    'homework.deadlineLabel': '⏰ Deadline:',
    'homework.deadlineDefault': 'By next lesson',
    'homework.deadlinePlaceholder': 'By next lesson (18.09.2026)',
    'homework.recommendationLabel': '💡 Additional recommendations:',
    'homework.recommendationPlaceholder': 'E.g., pay attention to irregular verbs',
    'homework.recipientsTitle': 'Recipients (Parents & Students)',
    'homework.selectAll': 'Select all',
    'homework.deselectAll': 'Deselect all',
    'homework.noEmailWarning': '{count} recipients do not have an email. You can enter it directly below.',
    'homework.selfStudent': 'Student directly',
    'homework.primaryContact': 'Primary contact',
    'homework.previewSubheading': 'This is how the email will look in the parent\'s inbox:',
    'homework.previewEmailSubject': 'Subject:',
    'homework.emailSchoolCenter': 'Learning Center',
    'homework.emailGreeting': 'Hello!',
    'homework.emailIntro': 'Here is the information from the recent lesson and the assignment for self-study.',
    'homework.emailLessonDate': '📅 Lesson date:',
    'homework.emailTeacher': '👨‍🏫 Teacher:',
    'homework.emailTopic': '🎯 Lesson topic:',
    'homework.emailHomework': '📝 Homework assignment:',
    'homework.emailDeadline': '⏰ Deadline:',
    'homework.emailTeacherRec': '💡 Teacher recommendation:',
    'homework.emailAutoFooter': 'Generated automatically via School CRM',
    'homework.selectedCountLabel': 'Selected recipients:',
    'homework.of': 'of',
    'homework.sendingBtn': 'Sending via Resend...',
    'homework.sendBtn': 'Send',
    'homework.sentSuccess': 'Homework successfully sent to parents',
    'homework.timelineSaved': 'Sent event recorded in student and parent Timeline history.',
    ...
    'students.filterAdult': 'Adult Students',
  ...
  de: {
    ...
    'teacher.selectLessonToMark': 'UNTERRICHT ZUR ANWESENHEITSERFASSUNG WÄHLEN:',
    'teacher.myWeek': 'Meine Woche',
    'teacher.lessonJournal': 'Klassenbuch',
    'teacher.hwSavedToCard': 'Hausaufgabe wird in Unterrichtskarte gespeichert',
    'teacher.marked': 'Erfasst',
    'teacher.consecutiveMisses': 'Fehlzeiten in Folge!',
    'teacher.statsAutoUpdate': 'Statistiken werden automatisch aktualisiert',
    'teacher.saveAttendance': 'Anwesenheit speichern',
    'teacher.weeklyScheduleTitle': 'Stundenplan für die aktuelle Woche:',
    'teacher.todaySubtitle': 'Heute:',
    'teacher.savedToStudentTimeline': 'Wird in der Schüler-Zeitleiste gespeichert',

    // Homework Modal
    'homework.sendModalTitle': 'Hausaufgaben per E-Mail versenden',
    'homework.modalHeading': 'Hausaufgabe:',
    'homework.teacher': 'Lehrkraft:',
    'homework.tabSetup': 'Versand-Einstellungen',
    'homework.tabPreview': 'E-Mail-Vorschau',
    'homework.topicPrevLesson': 'Thema der vergangenen Stunde:',
    'homework.topicPlaceholder': 'Z.B. Past Simple vs Present Perfect',
    'homework.textLabel': '📝 Text der Hausaufgabe:',
    'homework.requiredField': 'Pflichtfeld',
    'homework.textPlaceholder': 'Beschreiben Sie die Aufgabe ausführlich (Seitenzahlen, Übungen, Links)...',
    'homework.deadlineLabel': '⏰ Abgabefrist:',
    'homework.deadlineDefault': 'Zur nächsten Stunde',
    'homework.deadlinePlaceholder': 'Zur nächsten Stunde (18.09.2026)',
    'homework.recommendationLabel': '💡 Zusätzliche Empfehlungen:',
    'homework.recommendationPlaceholder': 'Z.B. auf unregelmäßige Verben achten',
    'homework.recipientsTitle': 'Empfänger (Eltern & Schüler)',
    'homework.selectAll': 'Alle auswählen',
    'homework.deselectAll': 'Auswahl aufheben',
    'homework.noEmailWarning': 'Für {count} Empfänger ist keine E-Mail hinterlegt. Sie können diese direkt unten eingeben.',
    'homework.selfStudent': 'Schüler selbst',
    'homework.primaryContact': 'Hauptkontakt',
    'homework.previewSubheading': 'So sieht die E-Mail im Postfach der Eltern aus:',
    'homework.previewEmailSubject': 'Betreff:',
    'homework.emailSchoolCenter': 'Bildungszentrum',
    'homework.emailGreeting': 'Guten Tag!',
    'homework.emailIntro': 'Hier finden Sie die Informationen zur vergangenen Stunde und die Aufgaben zur Vorbereitung.',
    'homework.emailLessonDate': '📅 Unterrichtsdatum:',
    'homework.emailTeacher': '👨‍🏫 Lehrkraft:',
    'homework.emailTopic': '🎯 Thema der Stunde:',
    'homework.emailHomework': '📝 Hausaufgabe:',
    'homework.emailDeadline': '⏰ Abgabefrist:',
    'homework.emailTeacherRec': '💡 Empfehlung der Lehrkraft:',
    'homework.emailAutoFooter': 'Automatisch generiert über School CRM',
    'homework.selectedCountLabel': 'Ausgewählte Empfänger:',
    'homework.of': 'von',
    'homework.sendingBtn': 'Versand über Resend...',
    'homework.sendBtn': 'Senden',
    'homework.sentSuccess': 'Hausaufgabe erfolgreich an Eltern gesendet',
    'homework.timelineSaved': 'Der Versand wurde im Verlauf der Schüler und Eltern protokolliert.',
    ...
    'students.filterAdult': 'Erwachsene Kursteilnehmer',
