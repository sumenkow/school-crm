...
export const TRANSLATIONS: Record<SupportedLanguage, Record<string, string>> = {
  ru: {
    ...
    'groups.subtitle': 'Расписание занятий, наполняемость и преподаватели курсов',
    ...
    'crm.search': 'Поиск лида по имени, телефону, Telegram...',
    'crm.stageNew': 'Новая заявка',
    'crm.stageContacted': 'Связались',
    'crm.stageTrialScheduled': 'Пробный назначен',
    'crm.stageTrialCompleted': 'Пробный проведен',
    'crm.stageEnrolled': 'Оплатил / Зачислен',
    'crm.stageLost': 'Отказ / Архив',
  ...
  en: {
    ...
    'groups.subtitle': 'Class timetables, student capacities, and course teachers',
    ...
    'crm.search': 'Search leads by name, phone, Telegram...',
    'crm.stageNew': 'New Inquiry',
    'crm.stageContacted': 'Contacted',
    'crm.stageTrialScheduled': 'Trial Scheduled',
    'crm.stageTrialCompleted': 'Trial Held',
    'crm.stageEnrolled': 'Enrolled / Paid',
    'crm.stageLost': 'Lost / Archived',
  ...
  de: {
    ...
    // Groups
    'groups.title': 'Studiengruppen',
    'groups.subtitle': 'Stundenpläne, Raumbelegung und Kursleiter',
    ...
    'crm.search': 'Leads nach Name, Telefon, Telegram suchen...',
    'crm.stageNew': 'Neue Anfrage',
    'crm.stageContacted': 'Kontaktiert',
    'crm.stageTrialScheduled': 'Probestunde vereinbart',
    'crm.stageTrialCompleted': 'Probestunde absolviert',
    'crm.stageEnrolled': 'Eingeschrieben / Bezahlt',
    'crm.stageLost': 'Verloren / Archiv',
